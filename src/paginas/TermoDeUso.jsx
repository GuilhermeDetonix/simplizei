...
const TermoDeUso = () => {
  return (
    <PageWrapper>
      <Container>
        <Title>Termos de Uso - Simplizei</Title>
        ...
        <Section>
          ...
          <Paragraph>
            A coleta e tratamento de dados pessoais estão em conformidade com a Lei Geral de Proteção de Dados (Lei nº 13.709/2018). Os dados serão utilizados exclusivamente para fins de aprimoramento da experiência do usuário, segurança e cumprimento de obrigações legais.
          </Paragraph>
        </Section>
